...
num_blocks = 6;
block_duration = 50.365; % in seconds
...
output_file = sprintf('sub-%s_perception_timestamps.txt', participant_num);
...
for block = 1:num_blocks
    ...
    if mod(block, 2) == 0
        word = voiced_word;
        block_name = 'voiced';
        audio_file = '/home/sayantan/Documents/Octave/zoo.wav';
    else
        word = voiceless_word;
        block_name = 'voiceless';
        audio_file = '/home/sayantan/Documents/Octave/sue.wav';
    end
